...
<html>
    ...
    <body>
                ...
                <div id="nav-bar">
                    <nav>
                        <ul id="nav-list">
                            ...
                            <li id="login-link" class="nav-items"><i id="user-icon" class="fa-solid fa-circle-user"></i><a href="/login">Login</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
        ...
        <section id="welcome-cover">
            ...
            <div id="text-welcome-cover"><span>LET'S LOGIN FIRST</span></div>
